...
public class ContainerPlasmaStorage extends ContainerHeat {

	public ContainerPlasmaStorage(final int windowId, final PlayerInventory playerInventory,
			final PacketBuffer data) {
		this(windowId, playerInventory, getTileEntity(playerInventory, data));
	}

	public ContainerPlasmaStorage(int id, PlayerInventory inv, final TileHeatMachineBase tile) {
