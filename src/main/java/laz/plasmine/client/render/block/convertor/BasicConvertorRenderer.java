...
public class BasicConvertorRenderer extends BaseConvertorRenderer {
	...
	public void render(TileConvertorBase tile, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer buffer,
		...
		model.render(matrixStackIn, ivertexbuilder, combinedLightIn, OverlayTexture.NO_OVERLAY, 1f , 1f, 1f, 1.0F);
		matrixStackIn.pop();
	}
}
