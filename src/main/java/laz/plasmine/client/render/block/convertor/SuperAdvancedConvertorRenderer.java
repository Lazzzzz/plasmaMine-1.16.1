...
public class SuperAdvancedConvertorRenderer extends BaseConvertorRenderer {

	public SuperAdvancedConvertorRenderer(TileEntityRendererDispatcher rendererDispatcherIn) {
	...
	public void render(TileConvertorBase tile, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer buffer,
		...
		model.render(matrixStackIn, ivertexbuilder, combinedLightIn, OverlayTexture.NO_OVERLAY, 0.3f , 0.3f, 0.3f, 1.0F);
		matrixStackIn.pop();
	}
}
