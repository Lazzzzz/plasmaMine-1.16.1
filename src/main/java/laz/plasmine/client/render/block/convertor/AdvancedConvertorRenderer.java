...
public class AdvancedConvertorRenderer extends BaseConvertorRenderer {

	public AdvancedConvertorRenderer(TileEntityRendererDispatcher rendererDispatcherIn) {
	...
	public void render(TileConvertorBase tile, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer buffer,
		...
		model.render(matrixStackIn, ivertexbuilder, combinedLightIn, OverlayTexture.NO_OVERLAY, 0.5f , 0.5f, 0.5f, 1.0F);
		matrixStackIn.pop();
	}
}
