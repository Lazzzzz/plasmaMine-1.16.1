...
public class IonizerScreen extends ContainerScreen<ContainerIonizer> {

	public IonizerScreen(ContainerIonizer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
